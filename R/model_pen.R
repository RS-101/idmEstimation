...
#' Fit Penalized Spline Model for Illness-Death Data
#'
...
#' @param knots_12 Numeric vector of knot positions for 1→2 transition. If \code{NULL},
#'   created automatically. Default is \code{NULL}.
#' @param knots_13 Numeric vector of knot positions for 1→3 transition. Default is \code{NULL}.
#' @param knots_23 Numeric vector of knot positions for 2→3 transition. Default is \code{NULL}.
#' @param degree Integer. Degree of the M-spline basis. Default is 3 (cubic).
#' @param n_knots Integer. Number of knots if not specified. Default is 7.
#' @param kappa_12 Numeric vector of smoothing parameters to try for 1→2. If \code{NULL},
#'   uses a logarithmic grid from 0.01 to 1e20. Default is \code{NULL}.
#' @param kappa_13 Numeric vector of smoothing parameters for 1→3. Default is \code{NULL}.
#' @param kappa_23 Numeric vector of smoothing parameters for 2→3. Default is \code{NULL}.
#' @param verbose Logical. If \code{TRUE}, prints progress during cross-validation.
#'   Default is \code{TRUE}.
#' @param run_in_parallel Logical. If \code{TRUE}, evaluates smoothing parameter grid
...
#'
#' @seealso \code{\link{fit_pc_model}}, \code{\link{fit_npmle}}
#' @export
